    ...
    <div className="bg-transparent min-h-screen transition-colors duration-500">
      ...
      >
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div
            className={`flex justify-between items-center mb-12 ${isAr ? "flex-row-reverse" : ""}`}
          >
            <Link
              href={`/${locale}/blog`}
          ...
          <header className="mb-16 space-y-8">
            ...
            <h1
              className={`font-black text-slate-900 dark:text-white leading-[1.1] tracking-tight text-balance ${isAr ? "text-5xl lg:text-7xl" : "text-6xl lg:text-8xl"}`}
            >
              {post.title}
            </h1>
          </header>
          ...
          <footer className="mt-32 relative">
            ...
            <div className="p-12 bg-white/50 dark:bg-slate-900/50 backdrop-blur-2xl rounded-[3.5rem] border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-10 transition-all">
              <div
                className={`flex items-center gap-8 text-center md:text-start ${isAr ? "md:flex-row-reverse md:text-right" : "md:flex-row"}`}
              >
