          ...
          >
            <div>
              ...
              <h2 className="text-5xl lg:text-7xl font-black text-slate-900 tracking-tighter mb-6">
                ...
                <span className="text-sky-600">Great.</span>
              </h2>
              <p className="text-slate-500 font-medium text-lg max-w-md leading-relaxed">
                Have a project in mind or just want to chat about system
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 text-slate-900 font-bold hover:text-sky-600 transition-colors group"
              >
              ...
              <div className="flex gap-4 pt-4">
                <a
                  href="https://www.linkedin.com/in/sameh-dheir/"
                  target="_blank"
                  className="w-12 h-12 bg-slate-900 text-white rounded-2xl flex items-center justify-center hover:bg-sky-600 transition-all"
                >
                  <FaLinkedin size={20} />
                </a>
                <a
